...
class InquiryAddExtraPickupScreen extends StatefulWidget {
  const InquiryAddExtraPickupScreen({super.key});

  @override
  State<StatefulWidget> createState() => _InquiryAddExtraPickupState();
}

class _InquiryAddExtraPickupState extends State<InquiryAddExtraPickupScreen> {
  ...
  String _selectedWasteType = 'Bulky Items'; // Initial value

  final List<String> wasteTypes = ['Bulky Items', 'e-waste', 'Other waste'];
  ...
  void _submitForm(BuildContext context) async {
    if (_formKey.currentState!.validate()) {
      ...
      Inquiry entry = Inquiry(
        ...
        inquiryType: 'Extra Trash Pickups', 
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Extra Pickup problems was sent to assistant!')),
      );
                  ...
                  child: Form(
                    ...
                    child: Column(
                      children: [
                        ...
                        const SizedBox(height: 14),
                        TextFieldInput(
                          title: "Desired pickup date",  // Corrected typo
                          icon: Icons.date_range,
                          controller: _desiredPickupDate,
                        ...
                        SubmitButton(
                          icon: Icons.send,
                          text: "Submit Extra Trash Pickup",
                          whenPressed: _submitForm,  // Pass context explicitly
                        ),
                      ],
                    ),
                  ),
